...
public class DeleteAllBooks {
    ...
    void deleteAllBooks() {
        ...
        WebElement button = wait.until(element -> driver.findElement(By.xpath("//div[@class='text-center button']//button[@id='submit']")));

        assertEquals("Delete Account", button.getText());
